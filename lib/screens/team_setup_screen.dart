...
class _TeamSetupScreenState extends State<TeamSetupScreen> {
  ...
  void initState() {
    super.initState();
    final int numberOfTeams = widget.settings.totalPlayers ~/ 2;
    _teams = List.generate(
      numberOfTeams,
      (index) => Team(name: 'Team ${index + 1}', capacity: 2),
    );
  }

  Future<void> _openTeamNameDialog(int teamIndex) async {
    HapticFeedback.lightImpact();
    String tempName = _teams[teamIndex].name;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('LOBBY', style: TextStyle(letterSpacing: 2)),
        centerTitle: true,
      ),
      body: Column(
        children: [
          const Padding(
            ...
            child: Text(
              'Tap an empty slot to join a team!',
              style: TextStyle(
                fontSize: 14,
                        ...
                        child: Column(
                          children: List.generate(2, (slotIndex) {
                            ...
                            return GestureDetector(
                              onTap: () =>
                                  _openNameDialog(teamIndex, slotIndex),
                              child: Container(
